    ...
    photoAlbums: [
      {
        ...
        cover: 'hoshinominami_1',
      },
    ],
    graduatedDate: '2022-02-12',
  }),
  createMemberRaw({
    name: 'matsumurasayuri',
    nameNotations: [
      '松村',
      '沙友理',
      'まつむら',
