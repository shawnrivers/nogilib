...
const singlesRawObject = new Singles(singlesRawArray).rawObject;
const albumsRawObject = new Albums(albumsRawArray).rawObject;
...
describe("convertSongArtwork", () => {
  ...
  test("should return no image artwork when no single nor albums matched", () => {
